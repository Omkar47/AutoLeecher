...
async def extract_youtube_dl_formats(url, yt_dl_user_name, yt_dl_pass_word, user_working_dir):
    ...
    if e_response:
        ...
        error_message = e_response.replace(
            "Try With Another Bot Again and Again./nIf Still Getting Errors 🤷 Its Not Supported then.", ""
        )
...
async def extract_zmhdl_formats(url, user_working_dir):
    command_to_exec = [
        "youtube-dl",
        "--no-warnings",
        "--youtube-skip-dash-manifest",
